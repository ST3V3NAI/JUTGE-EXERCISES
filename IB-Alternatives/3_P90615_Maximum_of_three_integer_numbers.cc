/**
  ...
  *
  * @file 3_P90615_Maximum_of_three_integer_numbers.cc
  * @author Steven Abolaji Ibidokun alu0101619613@ull.edu.es
  * @date Oct 12 2024
  * @brief Write a program that reads three numbers and prints their maximum.This exercise is slightly harder than.
